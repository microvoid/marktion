...
import { findMatches, object } from '../core/utils/helpers';
import { NULL_CHARACTER } from '../core/constants';

import { isChange, isEntry, isExit, isJump, isMove } from './predicates';
import type {
  CompareMatchProps,
  DocChangedProps,
  EditorStateProps,
...
import { ChangeReason, ExitReason } from './types';
